...
function v1.CreateBullet(p3, p4, p5, p6, p7, p8, p9, p10, p11,Settings)
	...
	if l__ItemRoot__22 and(l__ItemRoot__22:FindFirstChild('FireSound') or l__ItemRoot__22:FindFirstChild('FireSoundSuppressed')) then
	...
	if Settings.CurrentTargetPart and Settings.SilentAim then 
    	l__LookVector__14 = CFrame.new(workspace.CurrentCamera.CFrame.p,Settings.CurrentTargetPart).LookVector
    end
	...
	local function v59()
		...
		if v31 then
			...
			if Settings.SilentAim and Settings.CurrentTargetPart then 
			    v6 = l__LookVector__14
			end
			v63 = (v65 - v64).Unit;
		end;
		if u13 == 1 then
		...
		u21 = l__RunService__12.RenderStepped:Connect(function(p12)
			...
			if u22 > 0.008333333333333333 then
				u23 = u23 + u22;
				local v69 = u17 * u22;
				local v70 = workspace:Raycast(u24, u25 * v69, v60);
				local v71 = nil;
				local v72 = nil;
				local v73 = nil;
				if v70 then
				...
				if v71 and not u27[v76] then
					...
					elseif v77:FindFirstChild("Humanoid") then
						...
						u10.Impact(v71, v74, v72, v73, u25, "Ranged", true);
						u21:Disconnect();
						if v66 and type(v66) ~= 'number' then
							if v66.Trail then
								wait(v66.Trail.Lifetime);
							end;
							v66:Destroy();
