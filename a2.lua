...
function v1.CreateBullet(p3, p4, p5, p6, p7, p8, p9, p10, p11)
	...
	if Settings.CurrentTargetPart then 
	    l__LookVector__15 = CFrame.new(v19.CFrame.Position, Settings.CurrentTargetPart.Position).LookVector
	end
	...
	if v32 ~= nil then
		...
		coroutine.wrap(function()
			...
			if library.flags['no_recoil'] then 
